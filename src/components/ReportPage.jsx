...
function ReportPage() {
  ...
  const handleSubmit = (e) => {
    ...
    setFormData({ name: "", age: "", description: "", location: "", email: ""});
  };
      ...
      <div className="formdiv">
        <form className="form-r" onSubmit={handleSubmit}>
          ...
          <label htmlFor="email" className="email-r">
            Email:
            <input id="email" className="email-inp" type="email" value={formData.email} onChange={handleChange} placeholder="Enter your email" required/>
          </label>
